...
<tr >
    ...
    <th style="color:Black">Bill Photos</th>
  ...
  try{
	   ...
	   PreparedStatement ps2=con.prepareStatement("select * from bill_photos ");
...
<tr>
     ...
     <td><a href="str.jsp?uid=<%=rs.getString("uid") %>">Bill Receipt</a></td>
