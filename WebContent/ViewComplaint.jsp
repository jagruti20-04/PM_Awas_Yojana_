...
<tr >
     ...
     <th style="color:Black; background-color:#f2f2f2">Awas ID</th>
    <th style="color:Black; background-color:#f2f2f2">Complaint</th>
  ...
  try{
	    Connection con=DbConnection.connect();
				 ...
				 PreparedStatement ps2=con.prepareStatement("select * from complaint_db ");
			...
			<tr>
			    ...
			    <td style="color:Black"><%= rs.getString("complaint")%></td>
