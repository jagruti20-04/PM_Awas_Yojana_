        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="registration.html">View Submitted Photo</a></li>
						<li><a href="ViewComplaint.jsp">View Complaints</a></li>
						 <li><a href="UserView.jsp">Submitted Bills</a></li>
...
<tr >
    ...
    <th style="color:Black">Submitted Photos</th>
  ...
  try{
	   ...
	   PreparedStatement ps2=con.prepareStatement("select * from home_photos ");
...
<tr>
     ...
     <td><a href="viewPhotos.jsp?uid=<%=rs.getString("uid") %>">Home Photos</a></td>
